//Account class with a double instance variable balance and a constructor and
...
public class Account
{
    ...
    public Account(String name, double balance)
    {
        ...
        //validate that the balance is greater than 0.0; if it's not, instance variable
